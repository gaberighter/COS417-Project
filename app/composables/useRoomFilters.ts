...
export const useRoomFilters = (rooms: Ref<Room[]>) => {
    ...
    const filteredRooms = computed(() => {
        return rooms.value.filter((room) => {
            ...
            if (
                !matchesBooleanFilter(room.equipment.projector, appliedFilters.projector)
            ) {
                return false
            }
            ...
            if (
                !matchesBooleanFilter(room.equipment.whiteboard, appliedFilters.whiteboard)
            ) {
                return false
            }
            ...
            if (
                !matchesBooleanFilter(room.equipment.labStations, appliedFilters.labStations)
            ) {
                return false
            }

            if (
                !matchesBooleanFilter(room.equipment.computers, appliedFilters.computers)
            ) {
                return false
            }
